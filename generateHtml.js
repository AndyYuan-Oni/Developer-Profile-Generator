...
function generateHTML(data, res, starcount) {
    return `<!DOCTYPE html>
    <html lang="en">
        ...
        <style>
            ...
            *::before {
            ...
            .photo-header img {
                ...
                object-fit: cover;
                margin-top: -75px;
                border: 6px solidblack ${colors[data.color].photoBorderColor};
                /*changed*/
            ...
            <div class="wrapper">
                <div class="photo-header">
                    ...
                    <div class="links-nav">
                        ...
                        <div class="col nav-link">
                            <a href="${res.data.blog}" target="blank" class="nav-link links-nav">
